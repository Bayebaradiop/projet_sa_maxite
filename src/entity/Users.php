...
class Users
{
    ...
    public function getNumeroCarteIdentite(): string { return $this->numeroCarteIdentite; }
    public function setNumeroCarteIdentite(string $numeroCarteIdentite): void { $this->numeroCarteIdentite = $numeroCarteIdentite; }
    ...
    public function getTypeUser(): TypeUser { return $this->typeUser; }
    public function setTypeUser(TypeUser $typeUser): void { $this->typeUser = $typeUser; }
